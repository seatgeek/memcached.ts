...
*/
var MemcacheNode = class extends hookified.Hookified {
	_host;
	_port;
	_socket = void 0;
	_timeout;
	...
	*/
	async connect() {
		return new Promise((resolve, reject) => {
			...
			if (this._tls) this._socket = (0, node_tls.connect)({
				host: this._host,
				port: this._port,
			...
			else this._socket = (0, node_net.createConnection)({
				host: this._host,
				port: this._port,
				keepAlive: this._keepAlive,
				keepAliveInitialDelay: this._keepAliveDelay
...
*/
var AutoDiscovery = class AutoDiscovery extends hookified.Hookified {
	_configEndpoint;
	_pollingInterval;
	_useLegacyCommand;
	_configVersion = -1;
...
*/
const hashFunctionForBuiltin$1 = (algorithm) => (value) => (0, node_crypto.createHash)(algorithm).update(value).digest().readInt32BE();
/**
...
* @returns A HashFunction that uses the specified algorithm
*/
const hashFunctionForBuiltin = (algorithm) => (value) => (0, node_crypto.createHash)(algorithm).update(value).digest().readUInt32BE(0);
/**
* Wraps a Buffer-based HashFunction into a StringHashFunction.
*/
...
function resolveHashLargeKeyOption(value) {
	if (value instanceof hashery.Hashery) return {
		enabled: true,
		hashery: value
	};
	return {
		enabled: value === true,
		hashery: new hashery.Hashery()
	};
}
/**
...
var Memcache = class extends hookified.Hookified {
	_nodes = [];
	_timeout;
	_keepAlive;
	_keepAliveDelay;
...
exports.BroadcastHash = BroadcastHash;
exports.Hashery = hashery.Hashery;
exports.Memcache = Memcache;
exports.default = Memcache;
exports.MemcacheEvents = MemcacheEvents;
exports.MemcacheNode = MemcacheNode;
exports.ModulaHash = ModulaHash;
exports.createNode = createNode;
exports.defaultRetryBackoff = defaultRetryBackoff;
exports.exponentialRetryBackoff = exponentialRetryBackoff;
